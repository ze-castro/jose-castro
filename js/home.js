...
const portugueseBtn = document.getElementById('home-portuguese');
const spanishBtn = document.getElementById('home-spanish');
const englishBtn = document.getElementById('home-english');

// add event listeners to the buttons
portugueseBtn.addEventListener('click', translateToPortuguese);
spanishBtn.addEventListener('click', translateToSpanish);
